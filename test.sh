...
export RUSTFLAGS="-C target-feature=+avx,+avx2,+fma"
cargo build --release
rm render.png
cargo run --release -- --input data/scene.ron --camera data/camera.ron --output render.png --num-samples 10 --max-bounces 4 --width 1920 --height 1080
